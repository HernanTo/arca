<?php
    class usuario{
        public function filtrarUser($tdd,$tdoc){
            ...
            $sql = "SELECT fk_pk_tipo_documentoU, documento_U , estado_U , CONCAT(pNombre_U, ' ', sNombre_U, ' ', pApellido_U, ' ', sApellido_U) as 'Nombre' , fechaNacimiento_U , direccion_U , correoElectronico_U , celular_U FROM usuario WHERE fk_pk_tipo_documentoU ='$tdd' AND documento_U = '$tdoc'";
    ...
    $crud = new usuario();
    $crud->filtrarUser($_POST["fk_pk_tipo_documentoU"] , $_POST["documento"]);
?>
s   